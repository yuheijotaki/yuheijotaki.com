...
- 前庭障害が発生する可能性があるため
  - 大きく動くアニメーションでめまいや吐き気を感じる人がいる
  - [WCAG 2.1 達成基準 2.3.3](https://waic.jp/translations/WCAG21/Understanding/animation-from-interactions.html)
    - 必須でないアニメーションはユーザーがオフにできるように、という要件
